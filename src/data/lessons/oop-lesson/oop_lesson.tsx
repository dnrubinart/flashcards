  ...
  units: [
    {
      ...
      items: [
        ...
        },
        {
          ...
          backSide: "Чрез полиморфизъм(нещо, което има много форми).",
        },
        {
        ...
        {
          frontSide:
            "Как постигаме множествено наследяване в Python? Какви са ползите?",
          backSide:
        ...
        {
          frontSide:
            "Какво представлява Method Resolution Order (MRO) на клас в Python?",
          backSide:
        ...
        },
        {
          ...
          backSide:
            "Вместо да създаваме един голям клас, създаваме малки класове, които представляват отделни части от функционалността, която искаме да има в крайния обект. След това създаваме основния обект, който съдържа инстанции на тези малки класове като свои атрибути. Тези класове имат HAS-A relationship.",
        },
      ],
    },
  ],
